...
This is a project in the Udacity DL Nanodegree. 
The library used is Pytorch.
Link to the original gtihub repo of Udacity is [here](https://github.com/udacity/deep-learning-v2-pytorch.git)
